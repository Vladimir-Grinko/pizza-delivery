...
import { Plus, Minus, Trash2, ShoppingBag, Package, ArrowRight, ImageOff } from 'lucide-react'
...
export function CartDrawer({ open, onOpenChange }: CartDrawerProps) {
  ...
  // Wrap items with error state
  const items: CartItemWithState[] = rawItems.map((item) => ({
    ...item,
    imageError: !!imageErrors[item.product_id],
  }))
